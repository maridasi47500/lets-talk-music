...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { comment_id: @concert.comment_id, image: @concert.image, title: @concert.title } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { comment_id: @concert.comment_id, image: @concert.image, title: @concert.title } }
